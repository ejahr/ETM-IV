...
header = "He Ne+(2pz^-1) -> He+ Ne | X -> B | 1A1 -> 2A1\n"

process = "1A1.2A1"
el_state = "B"
max_dissE = "8"
max_dissE_for_calc = 8 * EV2HARTREE
...
electron_energies = [5] #eV for spectrum
...
overlapicec.define_overlap_parameters(*overlapNeHe, lmax)
